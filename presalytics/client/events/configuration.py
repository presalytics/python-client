...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="http://api.presalytics.io/events",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("presalytics.client.events")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://api.presalytics.io/events",
