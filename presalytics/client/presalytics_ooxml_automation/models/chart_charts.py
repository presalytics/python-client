...
class ChartCharts(object):
    ...
    def __init__(self, parent_graphic_id=None, svg_blob_url=None, base_element_blob_url=None, changed_base_element_blob_url=None, package_uri=None, name=None, id=None):  # noqa: E501
