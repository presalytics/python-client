...
class OoxmlDocument(object):
    ...
    def __init__(self, id=None, created_at=None, created_by=None, updated_at=None, updated_by=None, story_id=None, delete_target_on_story_delete=None, ooxml_automation_id=None):  # noqa: E501
