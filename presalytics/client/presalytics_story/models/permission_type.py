...
class PermissionType(object):
    ...
    def __init__(self, id=None, created_at=None, created_by=None, updated_at=None, updated_by=None, name=None, can_edit=None, can_view=None, can_add_collaborators=None, can_delete=None, local_vars_configuration=None):  # noqa: E501
