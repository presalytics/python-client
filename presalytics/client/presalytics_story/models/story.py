...
class Story(object):
    ...
    def __init__(self, created_at=None, created_by=None, id=None, updated_at=None, updated_by=None, collaborators=None, ooxml_documents=None, outline=None, outline_history=None, revision=None, title=None, local_vars_configuration=None):  # noqa: E501
