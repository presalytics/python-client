...
class StoryOutlineHistory(object):
    ...
    def __init__(self, id=None, created_at=None, created_by=None, updated_at=None, updated_by=None, story_id=None, revision_number=None, outline=None, collaborator_user_id=None, local_vars_configuration=None):  # noqa: E501
