...
class StoryOutlineHistory(object):
    ...
    def __init__(self, created_at=None, created_by=None, id=None, updated_at=None, updated_by=None, collaborator_user_id=None, outline=None, revision_number=None, story_id=None, local_vars_configuration=None):  # noqa: E501
