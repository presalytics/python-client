...
from presalytics.client.story.exceptions import (
    ApiTypeError,
    ApiValueError
)
...
class DefaultApi(object):
    ...
    def story_id_file_ooxmlautomationid_delete(self, id, ooxml_automation_id, **kwargs):  # noqa: E501
        """Story: Delete Subdocument  # noqa: E501

        Deletes a subdcoument of this story (e.g., .pptx, .docx, .xlsx)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.story_id_file_ooxmlautomationid_delete(id, ooxml_automation_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.story_id_file_ooxmlautomationid_delete_with_http_info(id, ooxml_automation_id, **kwargs)  # noqa: E501

    def story_id_file_ooxmlautomationid_delete_with_http_info(self, id, ooxml_automation_id, **kwargs):  # noqa: E501
        """Story: Delete Subdocument  # noqa: E501

        Deletes a subdcoument of this story (e.g., .pptx, .docx, .xlsx)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.story_id_file_ooxmlautomationid_delete_with_http_info(id, ooxml_automation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method story_id_file_ooxmlautomationid_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `story_id_file_ooxmlautomationid_delete`")  # noqa: E501
        ...
        if ('ooxml_automation_id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `ooxml_automation_id` when calling `story_id_file_ooxmlautomationid_delete`")  # noqa: E501
    ...
    def story_id_get(self, id, **kwargs):  # noqa: E501
        ...
        :param bool refresh_cache: Force the api reload the `Story full` object
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def story_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'include_relationships', 'include_outline', 'full', 'refresh_cache']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'refresh_cache' in local_var_params:
            query_params.append(('refresh_cache', local_var_params['refresh_cache']))  # noqa: E501
