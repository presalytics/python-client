...
class Revealer(presalytics.story.components.Renderer):
    ...
    def get_meta_tags(self, body=tuple()):
        ...
        tags = [
            ...
            """<meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-eval' 'unsafe-inline' blob: a{0}; script-src 'self' 'unsafe-eval' 'unsafe-inline' {0} {1}; frame-src 'self' {2};">""".format(allowed_hosts, allowed, frame_hosts)
        ]
        return tags
