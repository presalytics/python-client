...
from presalytics import PresalyticsClient
...
class TestClient(unittest.TestCase):
    ...
    def test_client(self):
        ...
        """
        client = PresalyticsClient(config_file=self.config_file)
    ...
    def test_module_config(self):
        ...
        client = PresalyticsClient(config=PRESALYTICS)
        self.assertIsNotNone(client.ooxml_automation.api_client.client_id)

    def test_api_exception(self):
        exception_client = PresalyticsClient(config_file=self.config_file)
        ...
        ignore_client = PresalyticsClient(config_file=self.config_file, ignore_api_exceptions=True)
